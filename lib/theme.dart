...
Color primaryColor = Color(0xff38BE45);
Color secondaryColor = Color(0xff297D49);
Color alertColor = Color(0xffED6363);
Color priceColor = Color(0xff56B06A);
...
Color backgroundColor5 = Color(0xff22412D);
Color backgroundColor6 = Color(0xffFFFAFA);
